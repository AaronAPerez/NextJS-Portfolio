...
export const PERSONAL_INFO = {
  ...
  tagline:
    "Building accessible, SEO-optimized web applications with React, TypeScript, and Next.js",
  bio: "Full Stack Developer with 7+ years of User and IT support experience with specialized training in modern web technologies. Recent CodeStack Academy graduate with expertise in React, TypeScript, Next.js, and .NET development.",
  avatar: "/images/profile/headshot.webp",
  email: "aaronperezdev@gmail.com",
  resumeUrl: "/resume/Aaron-Perez-Resume.pdf",
  phone: "(209) 470-2061",
...
export const SITE_CONFIG = {
  ...
  description:
    "Full Stack Developer specializing in React, TypeScript, Next.js, and modern web technologies",
  locale: "en_US",
