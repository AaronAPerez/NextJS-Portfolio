...
export const MetaTags = ({
  ...
  description = "Full Stack Developer in Stockton, CA. Specializing in React, TypeScript, C#, .NET, and modern web applications. Available for hire. 8+ years experience.",
