...
//     onClick={onClick}
//     className={cn(
//       "relative px-4 sm:px-6 py-2.5 sm:py-3 rounded-full font-medium transition-all duration-300",
...
//       <Section id="skills" ref={ref} className="relative overflow-hidden py-20 md:py-24 lg:py-28">
//         {/* Background effects */}
...
//           >
//             <h2 id="skills-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 md:mb-6 text-gray-900 dark:text-white">
//               Skills & Technologies
//             </h2>
//             <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-6 md:mb-8 leading-relaxed px-4">
...
//                 <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 font-medium">Years Experience</div>
//               </div>
//             </div>
//           </motion.div>
