  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-earth-500">Loading dashboard...</div>
      </div>
    )
  }
            ...
            <Tooltip content={stat.tooltip}>
              <Card className="hover:shadow-lg transition-shadow cursor-pointer">
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`flex items-center justify-center w-12 h-12 bg-linear-to-br ${stat.color} rounded-lg`}
                  >
...
// import { deploySite } from "@/app/actions/github/deploySite";
// import { CodeIcon, GlobeIcon, RocketIcon } from "lucide-react";
...
//             <p className="text-gray-500 mb-4">{site.domain}</p>

//             <div className="space-y-3">
//               <a
//                 href={`/admin/${site.id}/files`}
