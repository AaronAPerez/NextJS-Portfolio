    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <label htmlFor="file-upload" className="cursor-pointer">
            <span className={`inline-flex items-center justify-center px-6 py-3 text-base font-semibold rounded-lg ${isUploading ? 'bg-gray-300 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 cursor-pointer'} text-white transition-colors`}>
      ...
      <Card className="p-4">
        <div className="flex flex-wrap gap-2">
          {(['all', 'HERO', 'ABOUT', 'HACIENDA', 'BLOG', 'LOGO', 'FAVICON', 'OG_IMAGE', 'GENERAL'] as const).map((type) => (
            <button
              key={type}
        ...
        <Card className="p-12 text-center">
          <div className="space-y-4">
            ...
            <label htmlFor="file-upload-empty" className="inline-block cursor-pointer">
              <span className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold rounded-lg bg-blue-600 hover:bg-blue-700 text-white transition-colors cursor-pointer">
